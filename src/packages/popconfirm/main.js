import popconfirmTemp from "./popconfirm.vue";
import Vue from "vue";
...
export default {
  ...
  props: {
    ...
    trigger: {
      validator(value) {
        return oneOf(value, ["hover", "click", "manual"]);
      },
      default: "click"
    },
    value: {
  ...
  methods: {
     ...
     */
    __renderTip() {
      const Tooltip = Vue.extend(popconfirmTemp);
    ...
    __setTipVisible() {
      ...
      this.tooltip.handleSubmit = this.handleSubmit;
      this.tooltip.handleCancel = this.handleCancel;
